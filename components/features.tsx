      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        <div className="space-y-24 md:space-y-32">
          {features.map((feature, index) => (
            <FeatureItem key={index} feature={feature} index={index} totalFeatures={features.length} />
          ))}
        </div>
      </div>
    </section>
    ...
    <div ref={ref} className="relative">
      ...
      >
        <div className="w-full md:w-1/2">
          <div
            className={`rounded-2xl overflow-hidden shadow-xl transform ${isEven ? "md:rotate-2" : "md:-rotate-2"} transition-transform hover:rotate-0 duration-500`}
          >
        ...
        <div className="w-full md:w-1/2 space-y-4">
          ...
          >
            <div className={`p-2 rounded-full bg-gradient-to-r ${feature.color} text-white`}>{feature.icon}</div>
          ...
          >
            <button
              className={`mt-4 inline-flex items-center text-white bg-gradient-to-r ${feature.color} px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-300`}
            >
              <span>Saber más</span>
