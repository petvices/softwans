...
// Definir tipos para las posiciones
...
export function FloatingIcons() {
  ...
  const calculateMovement = (index: number) => {
    ...
    switch (index) {
      ...
      case 1: return { x: -baseX, y: baseY };
      case 2: return { x: baseX, y: -baseY };
      case 3: return { x: -baseX, y: -baseY };
      case 4: return { x: baseY, y: baseX };
      case 5: return { x: -baseY, y: -baseX };
