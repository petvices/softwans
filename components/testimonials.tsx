  ...
  const testimonials = [
    {
      ...
      content:
        "Hypatia ha transformado por completo la forma en que gestiono mi negocio. Los recordatorios automáticos y el envío de correos me han ahorrado horas de trabajo cada semana.",
      rating: 5,
    },
    {
      ...
      content:
        "La capacidad de análisis de Hypatia es impresionante. Me ha ayudado a identificar tendencias en mi negocio que no había notado antes, lo que ha resultado en un aumento del 30% en ventas.",
      rating: 5,
    },
    {
      name: "Laura Martínez",
      ...
      content:
        "Como emprendedora, necesitaba una solución que me ayudara a gestionar múltiples tareas. Hypatia no solo cumplió con mis expectativas, sino que las superó. ¡Es como tener un asistente personal 24/7!",
      rating: 4,
    },
  ]
      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="mt-4 text-gray-500 md:text-xl max-w-[700px] mx-auto">
            Descubre cómo Hypatia está transformando la forma en que las personas gestionan sus negocios y aumentan su
            productividad.
          </p>
        </motion.div>
